...
if("TRUE" STREQUAL "TRUE")
  set(neato_driver_SOURCE_PREFIX /home/sytasch/ROS/turtle/catkin_ws/src/intro_to_ros/bv80bot/neato_robot/neato_driver)
  set(neato_driver_DEVEL_PREFIX /home/sytasch/ROS/turtle/catkin_ws/devel)
  ...
  set(neato_driver_INSTALL_PREFIX /home/sytasch/ROS/turtle/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'neato_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sytasch/ROS/turtle/catkin_ws/src/intro_to_ros/bv80bot/neato_robot/neato_driver/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT neato_driver_NUM_DUMMY_TARGETS)
      set(neato_driver_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::neato_driver::wrapped-linker-option${neato_driver_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR neato_driver_NUM_DUMMY_TARGETS "${neato_driver_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::neato_driver::wrapped-linker-option${neato_driver_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND neato_driver_LIBRARIES "${interface_target_name}")
