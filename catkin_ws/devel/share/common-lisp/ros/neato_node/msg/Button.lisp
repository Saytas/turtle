...
(cl:defmethod cl:initialize-instance :after ((m <Button>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Button)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name neato_node-msg:<Button> is deprecated: use neato_node-msg:Button instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <Button>))
